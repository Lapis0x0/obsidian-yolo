...
export const it: TranslationKeys = {
  ...
  learning: {
    ...
    outlineBuilder: {
      ...
      generatingHeading: 'Pianificazione del percorso...',
    ...
    cards: {
      ...
      reviewForgotHint: '< 1 min',
      reviewHard: 'Incerto',
      reviewHardHint: '10 min',
      reviewGood: 'Capito',
      reviewGoodHint: '2 giorni',
      ...
      reviewShortcuts: 'Spazio gira · ← ↑ → o 1 / 2 / 3 valuta · Esc torna',
    },
    exercises: {
      practice: 'Pratica',
      locatedTo: 'Posizione: ',
