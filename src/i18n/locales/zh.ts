...
export const zh: TranslationKeys = {
  ...
  settings: {
    ...
    asr: {
      title: '语音识别 (ASR)',
      descriptionV2:
        '每一行是一个 ASR 端点。标签会标出哪些功能选中了它；具体选择在 编辑器 → 语音输入 和 编辑器 → 音频文件转录 中设置。',
      descriptionV3:
        '语音提供商按 HTTP 短音频、HTTP 长音频、WebSocket 分栏管理；具体选择在 编辑器 → 语音输入 和 编辑器 → 音频文件转录 中设置。',
      sectionTitle: {
      ...
      audioFileActivePill: '音频文件转录当前选择',
      audioFileActivePillLabel: '音频转录',
      editConfigAria: '编辑配置',
  ...
  voiceInput: {
    ...
    audioFileFailed: '音频文件转录失败。',
    audioFileFailedWithMessage: '音频文件转录失败：{{message}}',
    ...
    audioFileDisabledNotice: '音频文件转录未在语音输入设置中启用。',
    failed: '语音输入失败。',
