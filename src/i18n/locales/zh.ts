...
export const zh: TranslationKeys = {
  ...
  learning: {
    ...
    home: {
      title: '学习中心',
      subtitle: '今天是 2026 年 6 月 28 日，你已经连续学习 5 天',
      newProject: '新建项目',
      todayReview: '今日待复习',
      dueCardsLabel: '张卡片到期',
      dueExercisesLabel: '道题待练习',
      startReview: '开始今日复习',
      reviewMeta: '跨 2 个项目 · 预计耗时 20 分钟',
      myProjects: '我的项目',
      sortRecent: '按最近活跃',
      sortCreated: '按创建时间',
      sortProgress: '按进度',
    ...
    cards: {
      ...
      showAnswer: '点击查看答案',
      reviewForgot: '忘了',
      reviewForgotHint: '< 1 分钟后',
      reviewHard: '模糊',
      reviewHardHint: '10 分钟后',
      reviewGood: '会了',
      reviewGoodHint: '2 天后',
      flipHint: '点击翻面或按空格',
      reviewDone: '本轮复习完成',
      ...
      backToBrowse: '返回浏览',
      reviewShortcuts: '空格 翻面 · ← ↑ → 或 1 / 2 / 3 评估 · Esc 回浏览',
    },
    exercises: {
      practice: '练习',
      locatedTo: '定位至：',
