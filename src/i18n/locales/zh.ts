...
export const zh: TranslationKeys = {
  commands: {
    ...
    readAloudSelection: '朗读选中内容',
    readAloudCurrentFile: '朗读当前文件',
    stopReadAloud: '停止朗读',
  },
  ...
  settings: {
    ...
    asr: {
      ...
      sectionEmpty: {
        'http-short-audio': '还没有 HTTP 短音频提供商。',
        'http-long-audio': '还没有 HTTP 长音频提供商。',
        websocket: '还没有 WebSocket 提供商。',
      },
      colName: '名称',
      colSummary: '格式 · 模型',
      colActions: '操作',
      ...
      unnamedConfig: '（未命名）',
      activePill: '语音输入当前选择',
      activePillLabel: '语音输入',
      audioFileActivePill: '音频文件转写当前选择',
      audioFileActivePillLabel: '音频转写',
      editConfigAria: '编辑配置',
      deleteConfigAria: '删除配置',
      deleteConfigMessagePrefix: '删除',
      deleteConfigTitle: '删除 ASR 配置',
      deleteConfigFailed: '删除 ASR 失败。',
      reorderConfigFailed: '调整 ASR 顺序失败。',
      emptyHint: '还没有 ASR 端点。点右上角「添加 ASR 配置」开始。',
      addConfig: '添加 ASR 配置',
      configName: '名称',
      configNameDesc: '列表里显示的名字。',
      baseURLRequired: '需要填写 Base URL。',
      modelRequired: '需要填写模型。',
      errorNoProvider: '还没有配置 ASR 提供商。',
      errorLongAudioNotImplemented: '长音频提供商适配器还没有实现。',
      errorIncompleteConfig: '这个 ASR 配置还不完整。',
      errorWebSocketMissingBaseUrl: '这个 WebSocket 提供商需要填写 Base URL。',
      errorTranscriptionRequestFailed: 'ASR 转写请求失败：{{detail}}',
      errorChatAudioRequestFailed: 'ASR 聊天音频请求失败：{{detail}}',
      apiFormat: 'API 形式',
      apiFormatTranscription: 'Transcription',
      apiFormatChatAudio: 'Chat Audio',
      apiFormatWebSocket: 'WebSocket',
      apiFormatDescTranscription: '上传一小段录音到 OpenAI 风格的转写接口。',
      apiFormatDescChatAudio: '把录音发给能听音频的聊天模型。',
      apiFormatDescWebSocket:
        '实时 WebSocket 转写。支持 Deepgram 兼容 /listen，也支持 WhisperLiveKit 原生 /asr。',
      baseURL: 'Base URL',
      baseURLDesc:
        '填写服务的基础地址；如果服务把版本号放在基础路径里，可以包含 /v1。具体接口路径在下方单独配置。',
      apiKey: 'API 密钥',
      apiKeyDesc: '本地部署可留空。',
      apiKeyPlaceholder: '输入你的 API 密钥',
      model: '模型',
      ...
      listenPath: 'Path',
      listenPathDesc: '使用所选 WS 语音协议要求的路径。',
      transcriptionPath: '转写路径',
      transcriptionPathDesc: '默认 /audio/transcriptions。',
      longAudioPathDesc:
        '当前长音频提供商的接口路径；切换提供商时会填入对应默认值。',
      uploadPath: '上传路径',
      uploadPathDesc: '文件上传接口路径。',
      ...
      webSocketProviderDesc: '切换后会自动填入该提供商常用的 Base URL 和路径。',
      webSocketProtocolDeepgram: 'Deepgram',
      webSocketProtocolWhisperLiveKit: 'WhisperLiveKit',
      webSocketPunctuate: '标点',
      webSocketPunctuateDesc: '为 Deepgram 兼容转写添加标点和大小写。',
      webSocketDiarize: '说话人区分',
      webSocketDiarizeDesc:
        '自动模式下，上下文语音默认关闭，音频文件转写默认开启。',
      ...
      apiSecret: 'APISecret',
      apiSecretDesc: '仅用于生成 ASR 请求签名。',
      apiSecretPlaceholder: '输入 API secret',
      secretId: 'SecretID',
      secretKey: 'SecretKey',
      jobPath: '任务路径',
      jobPathDesc: '创建转写任务的接口。可以填写完整 URL。',
      resultPath: '结果路径',
      ...
      longAudioSpeakerCountDesc: '0 表示自动判断说话人数。',
      longProviderCredentialsRequired: 'AppID、API key 和 API secret 都必填。',
      ...
      testRecordingDescWebSocket: '开始实时流式测试。说完后点击「停止」。',
      testRun: '运行测试',
      testStopStreaming: '停止',
      testRunning: '录音中…',
      testFinalizing: '正在结束…',
      testFailed: 'ASR 测试失败。',
      testTookMs: '耗时 {{ms}} ms',
      testEmptyResult: 'ASR 没有返回文字。',
      testStreamingRunning: '流式 ASR 测试中。说完后点击「停止」。',
      testStreamingUnsupported: '这个 ASR 提供商不支持流式测试。',
      testStreamingAutoStop: '流式 ASR 测试达到最长时长，正在停止…',
      testInvalidConfig: '配置无效。',
      testRecordingSeconds: '录音 {{seconds}} 秒…',
      testCallingAsr: '正在调用 ASR…',
      testBadgePassed: '✓ 通过',
      testBadgeFailed: '× 失败',
      testBadgeRecording: '● 录音中',
      testBadgeFinalizing: '… 正在结束',
    ...
    audioFileTranscription: {
      ...
      chunkHeaderMode: '分段标题',
      chunkHeaderModeDesc:
        'HTTP 分段转写时，可在每段文字前插入该段在原音频中的开始时间。',
      chunkHeaderMode_none: '不插入分段标题',
      'chunkHeaderMode_local-start-time': '原音频开始时间',
      outputMetadataMode: '输出元数据',
      outputMetadataModeDesc:
        '控制转写结果是否包含文件元数据和服务商返回的时间戳。',
      outputMetadataMode_none: '仅正文',
      outputMetadataMode_metadata: '元数据',
    ...
    tts: {
      ...
      editConfigAria: '编辑配置',
      deleteConfigAria: '删除配置',
      deleteConfigTitle: '删除 TTS 配置',
      deleteConfigMessagePrefix: '删除',
      reorderFailed: 'TTS 配置排序失败。',
      deleteFailed: '删除 TTS 配置失败。',
      saveFailed: '保存 TTS 配置失败。',
      configName: '名称',
      configNameDesc: '显示在朗读提供商选择器中。',
      apiFormat: 'API 格式',
      apiFormatDesc: '选择这个端点使用的协议。',
      format: {
      ...
      requestPath: '请求路径',
      requestPathDesc: '留空时使用适配器默认值。',
      apiKey: 'API key',
      apiKeyDesc: '本地无鉴权服务可留空。',
      apiKeyPlaceholder: '输入 API key',
      model: '模型',
      modelDesc: '发送给提供商的模型名。',
      voice: '声音',
      voiceDesc: '提供商侧的声音或说话人 ID。',
      outputFormat: '输出格式',
      outputFormatDesc: '请求提供商返回的音频格式。',
      transport: '传输方式',
      transportDesc:
        '桌面端使用的 HTTP 请求路径。除非提供商需要特定方式，否则建议使用自动。',
      transportMode: {
        auto: '自动',
      ...
      language: '语言',
      languageDesc: '提供商支持时可填写语言代码。',
      sampleRate: '采样率',
      sampleRateDesc: '可选输出采样率。留空则使用提供商默认值。',
      providerDefault: '提供商默认值',
      speed: '语速',
      speedDesc: '可选语速倍率。留空则使用提供商默认值。',
      styleInstruction: '风格指令',
      styleInstructionDesc: '提供商支持时，可填写朗读风格或语气要求。',
      testText: '测试文本',
      testTextDesc: '只用于本次测试的文本。',
      testPlaying: '正在播放测试音频。',
      testReady: '测试音频已生成。可使用下方播放器检查是否能正常播放。',
      testPlayback: '音频播放测试',
      testPlaybackDesc: '重复播放刚生成的样音，确认当前环境可以解码并播放。',
      testFailed: 'TTS 测试失败。',
      testRunning: '测试中...',
      testRun: '运行测试',
    },
    voiceIsland: {
      ...
      audioFileUnavailable: '请先启用音频文件转写并配置 ASR。',
      readAloudUnavailable: '请先启用朗读并配置 TTS。',
      mode: {
        'toggle-listen': '点击听写',
        'hold-to-talk': '长按听写',
        'audio-file': '音频文件',
    ...
    readAloud: {
      ...
      markdownModeDesc:
        '可读模式会跳过 frontmatter/代码，并按标签朗读链接；原始模式保留 Markdown 语法。',
      advancedToggle: '高级选项',
      ...
      cacheEnabled: '内存缓存',
      cacheEnabledDesc:
        '把已生成音频保留在内存中，直到关闭 Obsidian；只有文本、提供商、模型、声音、格式、语速和风格都一致时才复用。',
      autoSave: '自动保存生成音频',
      autoSaveDesc: '保存生成音频到下方目录，并启用拖出音频。',
      saveDir: '生成音频目录',
      saveDirDesc: '库内相对目录。不接受绝对路径。',
      speaker: '扬声器',
      speakerDesc: '选择朗读和 TTS 测试使用的输出设备。',
      speakerDefault: '系统默认',
      speakerFallbackName: '扬声器',
      speakerCurrent: '当前选择的扬声器',
      speakerTest: '测试扬声器',
      speakerTesting: '测试中...',
      speakerTestPlaying: '正在播放扬声器测试音。',
      speakerTestFailed: '扬声器测试失败。',
      speakerUnsupported: '当前环境不支持指定扬声器，将通过系统默认设备播放。',
    },
  },
  ...
  voiceInput: {
    ...
    modeSwitchToReadAloud: '点击切换为朗读',
    modeSwitchToToggle: '点击切换为点按模式',
    modeSwitchUnavailable: '没有其他可用语音模式',
    holdToTalkHint: '按住麦克风说话',
    audioFileDropHint: '拖入音频开始转写',
    audioFileCheckDropHint: '拖入文件后检查音频',
    audioFileUnsupportedDropHint: '仅支持音频文件',
    audioFileChecking: '正在检查…',
    audioFileConfirm: '确认上传',
    audioFilePreparing: '正在准备…',
    audioFileUploading: '正在上传…',
    audioFileInserting: '正在插入…',
    audioFileIdleHint: '拖入或选择音频',
    audioFileConfirmButton: '开始上传',
    audioFileChooseButton: '选择音频文件',
    audioFileFinished: '音频文件转写完成。',
    audioFileEmptyLongAudioResult:
      '长音频转写完成，但服务没有返回可插入的文本。',
    audioFileCancelled: '音频文件转写已取消。',
    audioFilePlanStream: '开始流式转写音频？',
    audioFilePlanChunked: '上传 {{count}} 个音频分段？',
    audioFilePlanLongAudio: '提交长音频？',
    audioFilePlanDirect: '上传这个音频文件并转写？',
    audioFileProgressInsertingChunks: '正在插入 {{done}}/{{total}}…',
    audioFileProgressTranscribingChunks: '正在转写 {{done}}/{{total}}…',
    audioFileProgressStreamingPercent: '正在流式传输 {{percent}}%…',
    audioFileProgressUploadingPercent: '正在上传 {{percent}}%…',
    ...
    audioFileSubmissionLongAudio: '长音频提供商',
    audioFileSubmissionDirect: '直接上传',
    audioFileMetadataSource: '来源',
    audioFileMetadataTranscribed: '转写时间',
    audioFileMetadataProvider: '提供商',
    audioFileMetadataSubmission: '提交方式',
    ...
    audioFileDirectChunkDurationHint:
      '如果这是提供商的上传大小限制，请缩短音频分段时长（当前 {{seconds}} 秒），让文件先分段再上传。',
    audioFileChunkedChunkDurationHint:
      '如果这是提供商的上传大小限制，请调低音频分段时长（当前 {{seconds}} 秒）。',
    audioFileProviderGenericDurationHint: '部分提供商需要更短的 WAV 分段。',
    ...
    asrConfigMissingBaseUrlNotice:
      '当前选择的 WebSocket 提供商需要填写 Base URL。',
    asrTranscriptionRequestFailed: 'ASR 转写请求失败：{{detail}}',
    asrChatAudioRequestFailed: 'ASR 聊天音频请求失败：{{detail}}',
    recorderPermissionDenied:
      '麦克风权限被拒绝。请在系统或 Obsidian 设置中授权。',
    recorderNoDevice: '没有找到麦克风。',
    recorderDeviceBusy: '麦克风正被占用或无法读取。',
    ...
    readAloudDisabledNotice: '朗读未在设置中启用。',
    readAloudNoProvider: '请先配置 TTS 提供商后再使用朗读。',
    readAloudNoText: '没有可朗读的文本。',
    readAloudPreparing: '正在准备朗读…',
    readAloudConfirmLongText: '文字较长，将分 {{segments}} 段播放',
    readAloudProgress: '正在朗读 {{index}}/{{total}}',
    readAloudPaused: '已暂停',
    readAloudCompleted: '朗读完成',
    readAloudFailed: '朗读失败。',
    readAloudFailedWithMessage: '朗读失败：{{message}}',
    readAloudPlaying: '正在朗读',
    readAloudCancelled: '朗读已停止。',
    readAloudAutoSaveFailed: '保存生成音频失败。',
    readSelection: '朗读选区',
    readNote: '朗读笔记',
    readAloudDragGeneratedAudio: '拖拽生成的音频',
    readAloudConfirmButton: '开始朗读',
    readAloudPauseButton: '暂停朗读',
    readAloudResumeButton: '继续朗读',
  },
