...
export const zh: TranslationKeys = {
  ...
  settings: {
    ...
    knowledgeBases: {
      ...
      localEmbedding: {
        groupLabel: '本地',
        groupDesc: '完全在本机运行嵌入计算，无需 API Key。',
        desktopOnly: '本地嵌入模型仅支持桌面端。',
        metaLine: '{{dimension}} 维 · {{languages}} · {{size}}',
        download: '下载',
        downloadingLine:
        ...
        sourceFilesLabel: '文件',
        deleteCurrentConfirmTitle: '删除当前使用的嵌入模型？',
        ...
        storageUsed: '已占用 {{size}}',
        manageDownloaded: '管理已下载模型',
        manageDownloadedConfirmTitle: '移除全部已下载模型？',
